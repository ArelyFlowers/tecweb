...
@$link = new mysqli('localhost', 'root', 'ArelyFlor89', 'marketzone');
...
<script>
    function confirmEdit(nombre, marca, modelo, precio, unidades, detalles, imagen) {
        var confirmationMessage = "¿Deseas editar este producto?\n\n";
    ...
    function send2form(nombre, marca, modelo, precio, unidades, detalles, imagen) {
        ...
        form.method = 'POST';
        form.action = 'http://localhost/tecweb/practicas/p07/p07-base/formulario_productos_v2.php';
